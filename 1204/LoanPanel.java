...
public class LoanPanel extends JPanel {
    ...
    public LoanPanel(LibraryMainGUI mainFrame) {
        ...
        JButton btnDo = new JButton("대출"), btnBack = new JButton("뒤로가기");
        ...
        btnDo.addActionListener(e -> {
            try {
                int res = new LoanDAO().loanBook(Integer.parseInt(tfBook.getText()), Integer.parseInt(tfMem.getText()));
                if(res==1) JOptionPane.showMessageDialog(this, "대출성공");
                else JOptionPane.showMessageDialog(this, "실패(재고없음 등)");
